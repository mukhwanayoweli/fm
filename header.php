...
<img src="images/fm logo.PNG" alt="FM Logo" style="vertical-align: middle; width: 50px; height: 50px; border-radius: 50%;"> <strong style="font-size: 30px;">100.6 BCU FM</strong></a>
				</div>
				...
				<nav class="navbar navbar-expand-lg navbar-light bg-light">
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav mr-auto">
							...
							<!--for streaming live-->
							<li class="nav-item">
								<a class="nav-link" href="streamlive.html">stream live</a>
							</li>

<!--for streaming live ends-->
